...
Future<bool> requestStoragePermission() async {
  if (Platform.isAndroid) {
    ...
    // 2) Fallback a permiso STORAGE para API ≤29 o si falla el anterior
    status = await Permission.storage.request();
    if (status.isGranted) {
      return true;
    }
    // 3) Denegado permanentemente ➔ abrir Ajustes
                             ...
                             webViewController.addJavaScriptHandler(
                              ...
                              callback: (args) async {
                                if (await requestStoragePermission()) {
                                  ...
                                  List<int> bytes = base64Decode(base64Data.split(',').last);
                                  ...
                                  String fileExtension = args.length > 1 ? args[1] : 'csv';
                                  String filePath = '$dir/report_$timestamp.$fileExtension';
                            ...
                            if (url.toString().startsWith("blob:")) {
                              String script = """
                                (async function() {
                                  ...
                                  reader.onloadend = () => {
                                    window.flutter_inappwebview.callHandler('blobHandler', reader.result);
                                  };
                                })();
                              """;
                              ...
                              print("Tarea de descarga iniciada con ID: $taskId");
                            }
